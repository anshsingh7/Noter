...
//   };
//   return (
//     <Layout meta={{title:"Dashboard - NOTER AI", description:"", keywords: ["dashboard, notes, tasks, productivity"]}}>
...
//             <div className="flex justify-between items-center mb-4">
//               <h2 className="text-lg font-semibold">Recent Notes</h2>
//               <Link to="/notes" className="text-purple-600 text-sm hover:underline">
//                 View All
//               </Link>
//             </div>
...
//             <div className="flex justify-between items-center mb-4">
//               <h2 className="text-lg font-semibold">Urgent Tasks</h2>
//               <Link to="/tasks" className="text-purple-600 text-sm hover:underline">
//                 View Board
//               </Link>
//             </div>
